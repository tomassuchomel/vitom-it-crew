...
export async function migrate() {
  await pool.query(`
    ...
    -- Per-user MCP tokeny (dřív ve file migraci 2026-07-13-mcp-tokens.sql,
    -- přesunuto do inline schema, aby vznikly vždy — file migrace po importu
    -- z prázdné DB neběží znovu, když prázdný dump je novější než migrace).
